...
Prebuilt `acac` binary for **linux-arm64**.
...
- Built on GitHub Actions from the [acac-cli](https://github.com/RyosukeDTomita/acac-cli) source — a reproducible **musl static** build produced via Nix (`nix build .#static`).
